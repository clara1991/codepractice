define("//misc.360buyimg.com/mtd/pc/components/sidePopMenu/1.0.0/sidePopMenu.js", ["//misc.360buyimg.com/mtd/pc/components/util/1.0.0/util.js"],
function(t) {
    "use strict";
    var e = t("//misc.360buyimg.com/mtd/pc/components/util/1.0.0/util.js"),
    i = _.Class.extend({
        ...
        init: function() {
            var t = this.config;
            this.$navCtn = t.$container.find(t.navCtnHook),
            this.$popCtn = t.$container.find(t.popCtnHook),
            this.$navItemList = this.$navCtn.find(t.navItemHook),
        ...
        initEvents: function() {
            var t = this,
            i = t.config;
            i.$container.bind("mouseleave", $.proxy(t.ctnLeave, t)),
            t.$navCtn.delegate(i.navItemHook, {
            ...
            e.throttle(t.navItemMove, t.moveTimer)),
            t.isBind = !0
        },
        ctnLeave: function() {
            var t = this,
            e = t.config;
            t.$navItemList.removeClass(e.navItemOn),
            t.$popCtn.hide(),
            t.$popItemList.hide(),
            t.moveTimer = null,
            t.enterTimer = null
        ...
        navItemEnter: function(t) {
            ...
            i.addClass(n.navItemOn).siblings(n.$container.selector + " " + n.navItemHook).removeClass(n.navItemOn),
            e.$popCtn.show();
            var a = e.$popItemList.eq(s);
            a.show().siblings(n.$container.selector + " " + n.popItemHook).hide(),
            n.isAuto && e.popAutoShow(s, i),
            "function" == typeof o && o({
                $displayEl: a
            })
        },
        popAutoShow: function(t, e) {
            ...
            e = e,
            n = i.config,
            t = e.index(n.$container.selector + " " + n.navItemHook),
            o = [],
            s = 0;
            ...
            case "right":
                ...
                s = i.$window.height().toFixed(0) - (o[t].thisPageY - i.$window.scrollTop()),
                o[t].thisPstY < o[t].thisHeight ? i.$popCtn.css("top", "0px") : s < i.$popCtn.height().toFixed(0) && i.$popCtn.css({
                    top: o[t].thisPstY - (i.$popCtn.height().toFixed(0) - s) + "px"
                });
                break;
            case "left":
                i.$popCtn.css({
        ...
        navItemMove: function(t) {
            function e() {
                clearTimeout(n.moveTimer),
                n.isBind && n.unbindNavItemEnter(),
                n.moveTimer = setTimeout(function() {
            ...
            function i() {
                clearTimeout(n.moveTimer),
                n.isBind || n.reBindNavItemEnter()
            }
            var n = t.data.thisObj,
            o = $(this),
            s = n.config,
            a = t,
            c = s.moveDeg * (2 * Math.PI / 360),
            h = Math.tan(c).toFixed(2),
            m = 0,
            l = 0,
            r = 0,
            p = null,
            ...
            return clearTimeout(n.enterTimer),
            n.enterTimer = setTimeout(function() {
                o.trigger("mouseenter", {
                    thisObj: n,
                    callback: s.itemEnterCallBack
                })
            },
            300),
            !1
